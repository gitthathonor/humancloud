...
<div class="card">
    <div class="card-body">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="title" placeholder="이력서 제목" value="${resume.resumeTitle}">
        </div>
        <div class="form-group">
       ...
       <div class="col-md-8">
        ...
        <div class="form-group">
            <input type="text" class="form-control" id="blog" placeholder="깃허브 주소나 블로그주소를 입력해주세요" value="${resume.resumeLink}">
        </div>
