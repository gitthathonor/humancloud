...
public class ResumeController {
  ...
  public String updateResumeForm(@PathVariable Integer resumeId, Model model) {
    model.addAttribute("resume", resumeService.이력서상세보기(resumeId).get("resume"));
    model.addAttribute("category", resumeService.이력서상세보기(resumeId).get("category"));
    System.out.println("==============");
    System.out.println();
    System.out.println("==============");
  ...
  public String detailResume(@PathVariable Integer resumeId, Model model) {
    model.addAttribute("resume", resumeService.이력서상세보기(resumeId).get("resume"));
    model.addAttribute("category", resumeService.이력서상세보기(resumeId).get("category"));
